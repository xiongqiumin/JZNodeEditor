...
void JZDesignerEditor::init(QDesignerFormEditorInterface *core)
{
    ...
    QDockWidget *r_widget = new QDockWidget("Widget Box");
    initWidgetBox(panel);    
    r_widget->setFeatures(QDockWidget::NoDockWidgetFeatures);
    r_widget->setWidget(panel);
    ...
    QDockWidget *r_w1 = new QDockWidget("object");
    QDockWidget *r_w2 = new QDockWidget("prop");
...
JZDesignerFormWindow *JZDesignerEditor::open(JZUiItem *file)
{    
