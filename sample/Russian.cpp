...
SampleRussian::SampleRussian()
{
    m_name = "russian";
    m_project.initUi();    
    m_script = dynamic_cast<JZScriptFile*>(m_project.getItem("./mainwindow/ÊÂ¼þ"));
...
void SampleRussian::addKeyEvent()
{
    ...
    key_eqRotate2->setPropValue(1, Qt::Key_Up);
    key_eqD2->setPropValue(1, Qt::Key_Down);
    key_eqL2->setPropValue(1, Qt::Key_Left);
    key_eqR2->setPropValue(1, Qt::Key_Right);
...
void SampleRussian::addClearLine()
{
    ...
    score_add->setParamInValue(1, 10);
