...
void SampleRussian::addInitGame()
{
    ...
    script->addConnect(func_start->flowOutGemo(0), set_score->flowInGemo());    
    ...
    JZNodeCreateObject *create_col = new JZNodeCreateObject();
...
void SampleRussian::addPaintEvent()
{
    ...
    expr_row->setExpr(exrp1);
    expr_col->setExpr(exrp2);
    ...
    JZNodeIf *shape_null = new JZNodeIf();
    ...
    JZNodeIf *branch_is_rect = new JZNodeIf();
    ...
    pt_expr_row->setExpr(exrp1);
    pt_expr_col->setExpr(exrp2);    
...
void SampleRussian::addCreateRect()
{
    ...
    JZNodeIf *branch_place = new JZNodeIf();
...
void SampleRussian::addGameLoop()
{
    ...
    JZNodeIf *is_rect_branch = new JZNodeIf();
    script->addNode(is_rect);
    ...
    //is game end
    JZNodeIf *is_game_end = new JZNodeIf();
...
void SampleRussian::addKeyEvent()
{
    ...
    JZNodeIf *branch_right = new JZNodeIf();
    JZNodeIf *branch_left = new JZNodeIf();
    JZNodeIf *branch_down = new JZNodeIf();
    JZNodeIf *branch_rotate = new JZNodeIf();
...
void SampleRussian::addClearLine()
{
    ...
    JZNodeIf *line_count_branch = new JZNodeIf();

    JZNodeIf *line_count_eq_col_branch = new JZNodeIf();
