...
{
    QString name = pinValue(paramIn(0));
...
JZNodeParam::JZNodeParam()
{
    ...
    m_type = Node_param;
    addParamOut("",Pin_dispName | Pin_editName);
}
...
JZNodeSetParam::JZNodeSetParam()
{
    ...
    addParamIn("",Pin_dispName | Pin_editName | Pin_editValue | Pin_dispValue);
    addParamOut("");
}
